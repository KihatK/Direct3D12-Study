...
void ShapesApp::Draw(const GameTimer& gt) {
	...
	auto barrierToRT = CD3DX12_RESOURCE_BARRIER::Transition(CurrentBackBuffer(), D3D12_RESOURCE_STATE_PRESENT, D3D12_RESOURCE_STATE_COPY_DEST);
	...
	auto barrierToPR = CD3DX12_RESOURCE_BARRIER::Transition(CurrentBackBuffer(), D3D12_RESOURCE_STATE_COPY_DEST, D3D12_RESOURCE_STATE_PRESENT);
...
void ShapesApp::BuildShadersAndInputLayout() {
	mShaders["standardVS"] = d3dUtil::CompileShader(L"ShapeColor.hlsl", nullptr, "VS", "vs_5_1");
	mShaders["opaquePS"] = d3dUtil::CompileShader(L"ShapeColor.hlsl", nullptr, "PS", "ps_5_1");
...
void ShapesApp::BuildShapeGeometry() {
	...
	GeometryGenerator::MeshData box = geoGen.CreateBox(1.5f, 0.5, 1.5f, 3);
